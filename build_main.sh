...
clang++ -std=c++17 -fobjc-arc \
  -I/opt/homebrew/include -I/opt/homebrew/include/opus -L/opt/homebrew/lib -I/usr/local/include -I/usr/local/include/opus -I"$ROOT_DIR" \
  ...
  -lglfw -ljack -lsndfile -lopusfile -lopus -logg \
  "${EXTRA_LIBS[@]:-}" \
