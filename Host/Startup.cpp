...
namespace {
    ...
    const std::vector<std::pair<std::string, std::string>>& shaderFileTable() {
        static const std::vector<std::pair<std::string, std::string>> kShaderFiles = {
            ...
            {"PACKED_TERRAIN_FACE_VERTEX_SHADER", "Procedures/Shaders/PackedTerrainFace.vert.wgsl"},
            ...
            {"PACKED_TERRAIN_OCCLUSION_FACE_VERTEX_SHADER", "Procedures/Shaders/PackedTerrainOcclusionFace.vert.wgsl"},
            ...
            {"RAIN_FULLSCREEN_VERTEX_SHADER", "Procedures/Shaders/RainFullscreen.vert.wgsl"},
            {"RAIN_FULLSCREEN_FRAGMENT_SHADER", "Procedures/Shaders/RainFullscreen.frag.wgsl"},
            {"RAIN_RIPPLE_VERTEX_SHADER", "Procedures/Shaders/RainRipple.vert.wgsl"},
            {"RAIN_RIPPLE_FRAGMENT_SHADER", "Procedures/Shaders/RainRipple.frag.wgsl"},
            {"CLOUD_VERTEX_SHADER", "Procedures/Shaders/Cloud.vert.wgsl"},
            {"CLOUD_FRAGMENT_SHADER", "Procedures/Shaders/Cloud.frag.wgsl"},
            {"GRASS3D_VERTEX_SHADER", "Procedures/Shaders/3DGrass.vert.wgsl"},
            {"GRASS3D_FRAGMENT_SHADER", "Procedures/Shaders/3DGrass.frag.wgsl"},
            {"COASTER_VERTEX_SHADER", "Procedures/Shaders/Coaster.vert.wgsl"},
            {"COASTER_FRAGMENT_SHADER", "Procedures/Shaders/Coaster.frag.wgsl"},
            ...
            {"AURORA_VERTEX_SHADER", "Procedures/Shaders/Aurora.vert.wgsl"},
            {"AURORA_FRAGMENT_SHADER", "Procedures/Shaders/Aurora.frag.wgsl"},
            ...
            {"TITLE_LOGO_VERTEX_SHADER", "Procedures/Shaders/TitleLogo.vert.wgsl"},
            {"TITLE_LOGO_FRAGMENT_SHADER", "Procedures/Shaders/TitleLogo.frag.wgsl"},
            {"SCOPE_TEXT_VERTEX_SHADER", "Procedures/Shaders/ScopeText.vert.wgsl"},
            {"SCOPE_TEXT_FRAGMENT_SHADER", "Procedures/Shaders/ScopeText.frag.wgsl"},
